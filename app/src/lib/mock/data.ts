...
export const USERS: User[] = [
  {
    ...
    sport: 'padel', skill_level: 'intermediate', gender: 'female', language: 'en', dob: '1995-04-12',
  ...
  },
  {
    ...
    sport: 'padel', skill_level: 'intermediate', gender: 'male', language: 'en', dob: '1992-09-03',
  ...
  },
  {
    ...
    sport: 'tennis', skill_level: 'advanced', gender: 'female', language: 'en', dob: '1997-01-21',
  ...
  },
  {
    ...
    sport: 'badminton', skill_level: 'intermediate', gender: 'male', language: 'ar', dob: '1994-06-30',
  ...
  },
  {
    ...
    sport: 'tennis', skill_level: 'intermediate', gender: 'female', language: 'ar', dob: '1996-08-25',
  ...
  },
  {
    ...
    sport: 'padel', skill_level: 'advanced', gender: 'male', language: 'ar', dob: '1990-12-02',
...
export const MATCHES: Match[] = [
  // NEXT UP — joined, starts in 3h (open: one spot left)
  {
    ...
    start_time: iso(3), end_time: iso(4), skill_level: 'intermediate',
  ...
  // Hosted by you — Thursday singles, needs one more
  {
    ...
    start_time: iso(65), end_time: iso(66), skill_level: 'intermediate',
  ...
  // This week — Saturday open match (joined)
  {
    ...
    start_time: iso(113), end_time: iso(114.5), skill_level: 'any',
  ...
  // Discover — badminton tonight (open)
  {
    ...
    start_time: iso(6), end_time: iso(7), skill_level: 'intermediate',
  ...
  // JUST PLAYED — ended 2h ago, inside 24h post-match window (you played)
  {
    ...
    start_time: iso(-3), end_time: iso(-2), skill_level: 'intermediate',
  ...
  // CLOSED — played last week (Past tab, won)
  {
    ...
    court_number: 'Court 1', route_start: null, route_end: null, round_trip: false,
    start_time: iso(-170), end_time: iso(-169), skill_level: 'intermediate',
    total_spots: 4, spots_available: 0, fee_total: 100, fee_per_player: 25,
  ...
  // CANCELLED — was tomorrow
  {
    ...
    court_number: 'Court 2', route_start: null, route_end: null, round_trip: false,
    start_time: iso(26), end_time: iso(27), skill_level: 'beginner',
